...
if (!isset($_SESSION['role'])) {
    ...
    <body class="skin-black">
        ...
        <!-- <div class="col-xs-12 col-sm-6 col-md-8" style="" >
            <div style=" background: black;" >
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; margin-right:10px; border: 2px solid black;">
                    <center><image src="" style="width:90%;height:164px;"/></center>
        ...
        <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  width: 100%;">
            ...
            <div class="col-xs-12 col-md-12 text-center">
                ...
                if (isset($_GET['resident'])) {
                    // Retrieve resident details from the database based on the 'resident' parameter
                    ...
                    if ($row) {
                        // Resident details found, proceed to display the form
