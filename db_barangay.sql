...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Aug 29, 2024 at 02:12 AM
...
CREATE TABLE IF NOT EXISTS `tblhousehold` (
  ...
  `totalhouseholdmembers` int NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tblresident` (
  ...
  `igpitID` int NOT NULL,
  `philhealthNo` int NOT NULL,
